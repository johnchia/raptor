...
const struct help_entry help_entries[] = {
	...
	{NULL, "                                    rvd is ordered through rcd)"},
	{NULL,
	...
	{"rvd", "set-brightness <val|auto>           ISP brightness"},
	{"rvd", "set-contrast <val|auto>             ISP contrast"},
	{"rvd", "set-saturation <val|auto>           ISP saturation"},
	{"rvd", "set-sharpness <val|auto>            ISP sharpness"},
	{"rvd", "set-hue <val>                       ISP hue (0-255)"},
	{"rvd", "set-sinter <val>                    Spatial NR (0-255)"},
	{"rvd", "set-temper <val>                    Temporal NR (level)"},
	...
	{"rvd", "set-drc <val|auto>                  Dynamic range compression"},
	...
	{"rvd", "set-defog-strength <val|auto>       Defog strength"},
