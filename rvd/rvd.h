...
#define RVD_OSD_RETRY_INTERVAL	10 /* check ticks (~1s at 10Hz) */
...
struct rvd_state {
	...
	bool v4l2_backend;		/* reporting only: which backend the config chose */
	const rss_hal_caps_t *hal_caps; /* the created backend's capability surface */
